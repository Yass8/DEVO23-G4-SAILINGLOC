export const metaRoutes = {
  '/': { title: 'Accueil', description: 'Louez votre bateau entre particuliers partout en France.', canonical: 'https://dsp-dev-o24a-g4.fr/', ogImage: '/images/og-home.jpg' },
  '/about': { title: 'À propos', description: 'Découvrez SailingLoc et notre équipe.', canonical: 'https://dsp-dev-o24a-g4.fr/about', ogImage: '/images/og-about.jpg' },
  '/contact': { title: 'Contact', description: 'Contactez-nous pour toute question.', canonical: 'https://dsp-dev-o24a-g4.fr/contact', ogImage: '/images/og-contact.jpg' },
