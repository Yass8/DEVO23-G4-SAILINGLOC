...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('VOTRE_ENDPOINT_BACKEND/register', {
        method: 'POST',
        headers: {
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-2">
                Numéro de téléphone <span className="text-gray-500 text-xs">(optionnel)</span>
              </label>
              <input
                id="phone"
                name="phone"
                ...
                <input
                  ...
                  className={`w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#AD7C59] transition-colors pr-12 disabled:bg-gray-100 ${
                    formData.confirm_password && formData.password !== formData.confirm_password
                      ...
                      : "border-gray-300 focus:border-[#AD7C59]"
                  }`}
            ...
            <div className="flex items-start">
              <input
                ...
                onChange={handleChange}
                disabled={isLoading}
                className="h-4 w-4 text-[#AD7C59] focus:ring-[#AD7C59] border-gray-300 rounded mt-1 disabled:opacity-50"
                required
              />
              <label htmlFor="acceptTerms" className="ml-2 block text-sm text-gray-700">
                J'accepte les{" "}
                <Link to="/terms" className="text-[#AD7C59] hover:text-[#8B5A3C] transition-colors">
                  conditions d'utilisation
                </Link>{" "}
                et la{" "}
