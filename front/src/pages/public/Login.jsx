  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Exemple: data.token, data.user, data.accessToken, etc.
        ...
        // TODO: Adapter selon la structure d'erreur de votre backend
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                disabled={isLoading}
                className="h-4 w-4 text-[#AD7C59] focus:ring-[#AD7C59] border-gray-300 rounded disabled:opacity-50"
              />
